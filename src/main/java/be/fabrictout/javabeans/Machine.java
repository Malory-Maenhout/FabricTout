...
import be.fabrictout.enums.SizeEnum;
import be.fabrictout.enums.StatusMachineEnum;
import be.fabrictout.enums.TypeEnum;
...
public class Machine implements Serializable{
	...
	public Machine(String name, SizeEnum size, StatusMachineEnum status, boolean replace, String serialNumber, List<Area> areaList) {
		super();
		this.name = name;
		this.size = size;
		this.status = status;
